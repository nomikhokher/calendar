  ...
  template: `
    <ng-container *ngIf="vm$ | async as vm">
        <ng-container *ngIf="vm.item">
              <ui-page-header [title]="'Edit Calendar Event ' + vm.item?.name" linkPath=".." linkTitle="Back"></ui-page-header>
...
,
				WebUiFormField.fieldRow([
WebUiFormField.input('recurringEventId', { label: 'Recurring Event Id' }, {className: 'w-1/2  px-1', hide: true}),
...
WebUiFormField.typeahead('calendarId', {
  ...
  updateCalendarEvent(input: AdminUpdateCalendarEventInput) {
     ...
     this.store.updateCalendarEventEffect({calendarId,recurringEventId,isFirstInstance,title,description,start,end,allDay,recurrence})
  }
}
