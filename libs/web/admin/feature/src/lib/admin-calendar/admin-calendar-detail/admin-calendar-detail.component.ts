            ...
            <div class="w-full flex items-center justify-between p-6 space-x-6">
              <div class="flex-1 truncate">
                ...
                <p class="mt-1 text-gray-500 text-sm truncate">
                  Color: <span class="text-gray-900 text-sm font-medium truncate ml-2">{{ vm.item?.color }}</span>
                </p>
              </div>
              <p>
                Visible: <span class="text-gray-900 text-sm font-medium truncate ml-2">{{ vm.item?.visible }}</span>
              </p>
            </div>
            <div>
