...
import { WebCoreDataAccessService, AdminListSettingInput, Setting } from '@calendar/web/core/data-access'
...
@Injectable()
export class AdminSettingListStore extends ComponentStore<SettingListState> {
