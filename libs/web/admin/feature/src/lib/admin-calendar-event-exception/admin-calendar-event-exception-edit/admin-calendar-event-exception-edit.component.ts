  ...
  template: `
    <ng-container *ngIf="vm$ | async as vm">
      <ng-container *ngIf="vm.item">
        <ui-page-header
          [title]="'Edit Calendar Event Exception ' + vm.item?.name"
          linkPath=".."
          linkTitle="Back"
        ></ui-page-header>
        <div class="dark:bg-gray-800 px-6 py-4 rounded-md">
          <ui-form
            ...
            [fields]="fields"
            [model]="vm.item"
            (submitForm)="updateCalendarEventException($event)"
          >
...
export class AdminCalendarEventExceptionEditComponent {
  ...
  fields = [
    ...
    WebUiFormField.fieldRow([WebUiFormField.input('exdate', { label: 'Exdate' }, { className: 'w-1/2  px-1' })]),
  ]
