        ...
        <div class="dark:bg-gray-800 px-6 py-4 rounded-md">
          ...
          <div class="flex flex-wrap overflow-hidden lg:-mx-1 xl:-mx-2">
								...
								<div class="w-full overflow-hidden lg:my-1 lg:px-1 lg:w-full xl:my-2 xl:px-2 xl:w-1/2">
									<div class="text-lg font-medium text-gray-900 dark:text-gray-200">Event Id:</div><div class="text-lg font-medium text-gray-900 dark:text-gray-200">{{ vm.item?.event?.name }}</div>
								</div>
								<div class="w-full overflow-hidden lg:my-1 lg:px-1 lg:w-full xl:my-2 xl:px-2 xl:w-1/2">
									<div class="text-lg font-medium text-gray-900 dark:text-gray-200">Exdate:</div><div class="text-lg font-medium text-gray-900 dark:text-gray-200">{{ vm.item?.exdate }}</div>
								</div>
          </div>
        </div>
      </ng-container>
