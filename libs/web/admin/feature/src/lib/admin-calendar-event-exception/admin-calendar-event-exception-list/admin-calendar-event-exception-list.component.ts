...
@Component({
  template: `
    <ng-container *ngIf="vm$ | async as vm">
      <ui-page-header
        title="Calendar Event Exception"
        linkPath="create"
        linkTitle="Create Calendar Event Exception"
      ></ui-page-header>
      ...
      <ng-container *ngIf="!vm.loading">
        <ng-container *ngIf="!vm.items?.length">
          <div class="flex py-20 justify-center align-center">No Calendar Event Exception found...</div>
        </ng-container>
  ...
  `,
  providers: [AdminCalendarEventExceptionListStore],
})
export class AdminCalendarEventExceptionListComponent implements OnInit {
  readonly vm$ = this.store.vm$
  constructor(private readonly store: AdminCalendarEventExceptionListStore) {}
