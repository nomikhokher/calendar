...
import { AdminUserCalendarListStore } from './admin-user-calendar-list.store'

@Component({
  template: `
    <ng-container *ngIf="vm$ | async as vm">
      <ui-page-header title="User Calendar" linkPath="create" linkTitle="Create User Calendar"></ui-page-header>
                    ...
                    <div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                      <div class="truncate">
                        <div class="flex text-sm">
                          ...
                          <p class="ml-3 font-medium text-indigo-600 truncate">{{ item?.userId }}</p>
                        </div>
  ...
  `,
  providers: [AdminUserCalendarListStore],
})
export class AdminUserCalendarListComponent implements OnInit {
  readonly vm$ = this.store.vm$
  constructor(private readonly store: AdminUserCalendarListStore) {}
