  ...
  template: `
    <ng-container *ngIf="vm$ | async as vm">
        <ng-container *ngIf="vm.item">
              <ui-page-header [title]="'Edit Calendar Weekday ' + vm.item?.name" linkPath=".." linkTitle="Back"></ui-page-header>
...
,
				WebUiFormField.fieldRow([
WebUiFormField.input('value', { label: 'Value' }, {className: 'w-1/2  px-1'})				])
,
