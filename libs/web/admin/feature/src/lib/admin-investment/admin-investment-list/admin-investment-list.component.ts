...
@Component({
    ...
    <ng-container *ngIf="vm$ | async as vm">
      ...
      <ng-container *ngIf="!vm.loading">
        <ng-container *ngIf="!vm.items?.length">
          <div class="flex py-20 justify-center align-center">No Investment found...</div>
        </ng-container>
  ...
  `,
  providers: [AdminInvestmentListStore],
})
export class AdminInvestmentListComponent implements OnInit {
  readonly vm$ = this.store.vm$
  constructor(private readonly store: AdminInvestmentListStore) {}
