import { User } from '@calendar/web/core/data-access'
            ...
            <div class="hidden md:block">
              <div class="ml-4 flex items-center md:ml-6">
                ...
                <div class="ml-3 relative">
                  ...
                  -->
                  <div
                    class="origin-top-right absolute z-20 right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-gray-700 dark:text-gray-300 ring-1 ring-black ring-opacity-5"
                    role="menu"
