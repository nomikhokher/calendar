...
import { WebAuthStore } from '@calendar/web/auth/data-access'
import { Role } from '@calendar/web/core/data-access'
...
{ label: 'Investments', route: 'investments' },
        { label: 'Equipment-types', route: 'equipment-types' },
        { label: 'Equipment-sizes', route: 'equipment-sizes' },
        { label: 'Accessorial-fee-types', route: 'accessorial-fee-types' },
        { label: 'Accessorials', route: 'accessorials' },
        { label: 'Quotes', route: 'quotes' },
        // { label: 'Packaging-types', route: 'packaging-types' },
        // { label: 'Organizations', route: 'organizations' },
        // { label: 'Items', route: 'items' },
        // { label: 'Freight-classes', route: 'freight-classes' },
        // { label: 'Addresses', route: 'addresses' },
        // { label: 'National-motor-freight-classifications', route: 'national-motor-freight-classifications' },
