...
import { ApiSettingDataAccessModule } from '@calendar/api/setting/data-access'
...
@Module({
  ...
  providers: [ApiSettingFeatureAdminResolver, ApiSettingFeaturePublicResolver, ApiSettingFeatureUserResolver],
})
